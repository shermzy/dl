<%-- 
    Document   : successVerification
    Created on : Jun 4, 2014, 4:20:33 PM
    Author     : Sherman
--%>
<!DOCTYPE html>
        ...
        <div class="st-content"><!-- this is the wrapper for the content --> 
            <div class="st-content-inner">  
                ...
                <div class="content center">
                    <div class="email_verified alert alert-success">
                        You have successfully activated your account. You will be redirected shortly.
                    </div>
                </div>
            </div>
        </div>
