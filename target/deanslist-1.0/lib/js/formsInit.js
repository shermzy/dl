...
//execute validate here
        ...
        user_service.image = $('div.fileinput-preview img').attr('src');
        user_service.piclink = $('#cover').val();
...
function validateService() {
    ...
    if ($('#category-options').val() == 'nil') {
        ...
        $('#category').find('span.help-block').text("Your service is left in the abyss if not otherwise categorized!")
    }
